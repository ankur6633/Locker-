...
/// Admin Device & App Control Screen
class AdminLockControlScreen extends StatefulWidget {
  const AdminLockControlScreen({super.key});

  @override
  State<AdminLockControlScreen> createState() => _AdminLockControlScreenState();
}

class _AdminLockControlScreenState extends State<AdminLockControlScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_isRooted != null)
                          Text(
                            _isRooted == true
                                ? AppStrings.deviceRooted
                                : AppStrings.deviceNotRooted,
                            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                  color: _isRooted == true
                  ...
                  if (_isCheckingRoot)
                    ...
                    IconButton(
                      ...
                      tooltip: AppStrings.checkRootStatus,
                    ),
                ],
              ),
            ),
            ...
            const SizedBox(height: 24),
            // App Control Section
            _buildAppControlSection(context),
          ],
        ),
      ),
    );
  ...
  /// Build App Control Section
  Widget _buildAppControlSection(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: Theme.of(context).colorScheme.surface,
        borderRadius: BorderRadius.circular(20),
